...
[![API Reference](https://img.shields.io/badge/API--Utils-datafun--streaming-purple)](https://Thilde02.github.io/datafun-streaming/api/)
...
[**start kafka**](https://Thilde02.github.io/pro-analytics-02/kafka/start-kafka/).

If any command fails,
repeat the steps at
[**install kafka**](https://Thilde02.github.io/pro-analytics-02/kafka/install-kafka/)
...
For full instructions see
[**create topic**](https://Thilde02.github.io/pro-analytics-02/kafka/create-topic/).
...
To start fresh, see
[manage topics](https://Thilde02.github.io/pro-analytics-02/kafka/manage-topics/)
